...
public:
  ...
  class DynamicClientConnection : public RTSPServer::RTSPClientConnection
  {
	public:
		DynamicClientConnection(DynamicRTSPServer& ourServer,
			 int clientSocket, struct sockaddr_storage const& clientAddr,
			 Boolean useTLS = False);
    	virtual ~DynamicClientConnection()
		{
			std::cout << std::endl << std::this_thread::get_id()
			 << ": DynamicClientConnection:: ~ctor connection" << std::endl;
		}
  };
