...
DynamicRTSPServer::createNew(UsageEnvironment& env, Port ourPort,
  ...
  RTSPClientWorkerPool::GetInstance().Init(2);
...
DynamicRTSPServer::DynamicClientConnection::DynamicClientConnection(DynamicRTSPServer& ourServer,
...
{
  	std::cout << std::this_thread::get_id() << ": DynamicClientConnection:: ctor connection" << std::endl;
}


GenericMediaServer::ClientConnection*
DynamicRTSPServer::createNewClientConnection(int clientSocket, struct sockaddr_storage const& clientAddr) {
  // auto conn = new DynamicClientConnection(*this, clientSocket, clientAddr, fOurConnectionsUseTLS);
  // return conn;
